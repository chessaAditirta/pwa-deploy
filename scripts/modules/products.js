...
export const products = [
  new Product('Batik1', 'Batik 1', 25000, '../../images/batik1.jpg',
    'Ini adalah batik yang pertama bukan kedua.'),
  new Product('Batik2', 'Batik 2', 33000, '../../images/batik2.jpg',
    'Yang ini namanya batik kedua bukan orang kedua.'),
  new Product('Batik3', 'Batik 3', 22000, '../../images/batik3.jpg',
    'Ini batik yang ketiga walau semua tidak suka menjadi yang ketiga.'),
  new Product('Batik4', 'Batik 4', 45000, '../../images/batik4.jpg',
    'Batik 4 sering disebut juga yang keempat meski tak dianggap.'),
  new Product('Batik5', 'Batik 5', 50000, '../../images/batik5.jpg',
    'Sebagai yang kelima batik ini konsisten menjadi secret admire.'),
  new Product('Batik6', 'Batik 6', 60000, '../../images/batik6.jpg',
    'Ini batik yang keenam meski tak punya pengalaman menjalin hubungan.'),
  new Product('Batik7', 'Batik 7', 65000, '../../images/batik7.jpg',
    'Batik ini Ketujuh dengan semua keputusanmu.'),
  new Product('Batik8', 'Batik 8', 70000, '../../images/batik8.jpg',
    'Ini batik kedelapan walau bukan yang pertama semoga ini yang terbaik'),
  new Product('Batik9', 'Batik 9', 200000, '../../images/batik9.jpg',
